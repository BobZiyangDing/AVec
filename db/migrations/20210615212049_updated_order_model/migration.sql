/*
  ...
  - Added the required column `goi` to the `Order` table without a default value. This is not possible if the table is not empty.
  - Added the required column `ecoliType` to the `Order` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Order" ("id", "createdAt", "updatedAt", "name", "number", "description", "throughput", "status", "price", "payment", "topSequence", "hasDataplot", "hasDataset", "hasModel", "userId", "addressId") SELECT "id", "createdAt", "updatedAt", "name", "number", "description", "throughput", "status", "price", "payment", "topSequence", "hasDataplot", "hasDataset", "hasModel", "userId", "addressId" FROM "Order";
DROP TABLE "Order";
